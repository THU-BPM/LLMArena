    ...
    def _get_chat_action(
        ...
        while current_retry < max_retries:
            try:
                ...
                message += f"The board status is {board_status}.\nYou can only choose one of following columns: [ {available} ]."
