...
from openrl.arena.multiplayer_arena import MultiPlayerArena
...
def make_arena(
    ...
    **kwargs,
    ...
    dispatch_func = kwargs.get("dispatch_func",None)
    dispatch_func_multi = kwargs.get("dispatch_func_multi",None)

    if "undercover" in env_id:
        return MultiPlayerArena(env_fn, use_tqdm=use_tqdm, dispatch_func = dispatch_func_multi)
    return TwoPlayerArena(env_fn, use_tqdm=use_tqdm, dispatch_func = dispatch_func)
